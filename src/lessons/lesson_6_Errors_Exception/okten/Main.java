package lessons.lesson_6_Errors_Exception.okten;
...
public class Main {
    ...
    public static void main(String[] args) {
        writeWords(List.of("Jameson", "Bob", "Martin", "lkasjdjalksd"), "resources_for_lesson_6/words.txt");
        List<String> words = readWords("resources_for_lesson_6/words.txt");
    ...
    public static void fileOldApproachDemo() {
        ...
        File file = new File("resources_for_lesson_6/test.txt");
